...
describe('Login Logout Swag Labs',()=>{
    ...
    it('GX-10241|TC1 validar login correcto standard_user',()=>{
    ...
    it('GX-10241|TC2 validar login correcto problem_user',()=>{
        initsesion.inputUserName(login.users.problemUser)
        initsesion.inputPassword(login.users.correctPass)
        initsesion.clickButtonLogin()
    })

    it('GX-10241|TC3 validar login correcto performance_glitch_user',()=>{
    ...
    it ('GX-10241|TC4 Validar login con cuenta bloqueada',()=>{
    ...
    it('GX-10241|TC05 validar login account y password null',()=>{
        initsesion.clickButtonLogin()
        initsesion.get.ErrorMsj().should('have.text',login.errorMsg.UserNull)
    })

    it('GX-10241|TC06 validar login account valido y password null',()=>{
        initsesion.inputUserName('problem_user')
        initsesion.clickButtonLogin()
        initsesion.get.ErrorMsj().should('have.text',login.errorMsg.PassNull)
    })

    it('GX-10241|TC07 validar login account null y password valido',()=>{
        initsesion.inputPassword(login.users.correctPass)
        initsesion.clickButtonLogin()
        initsesion.get.ErrorMsj().should('have.text',login.errorMsg.UserNull)
    })

    it('GX-10241|TC08 validar login con user inexistente y password valido',()=>{
    ...
    it ('GX-10241|TC09 validar login con user problem_user',()=>{
        initsesion.inputUserName(login.users.problemUser)
        initsesion.inputPassword(login.users.correctPass)
        initsesion.clickButtonLogin()
    })

    it(' GX-10241|TC10 Validar url /cart.html',()=>{
    ...
    it('GX-10241| TC11 Validar url /checkout-step-one.html',()=>{
    ...
    it(' GX-10241|TC12 Validar url /checkout-step-two.html',()=>{
    ...
    it('GX-10241| TC13 Validar URL /checkout-complete.html',()=>{
    ...
    it('GX-10241|TC14 Validar logout correcto',()=>{
