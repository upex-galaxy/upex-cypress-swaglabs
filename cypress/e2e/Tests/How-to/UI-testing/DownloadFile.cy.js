describe('Cypress Downloadfile Testing', () => {
	...
	it('Small Size test', () => {
		Cypress.config('defaultCommandTimeout', 10000);
		cy.downloadFile('https://proof.ovh.net/files/10Mb.dat', 'cypress/downloads', '10Mio.dat');
	});
	it('PDF test', () => {
		cy.downloadFile('http://www.africau.edu/images/default/sample.pdf', 'cypress/downloads', 'sample.pdf');
	});
	it('Image Size test', () => {
