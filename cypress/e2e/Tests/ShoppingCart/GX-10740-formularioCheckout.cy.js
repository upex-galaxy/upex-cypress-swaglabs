...
describe('SwagLabs | Checkout Info | Insertar información del comprador.', () => {
	...
	it('10741 | TC01 validar que el usuario ingresa exitosamente a la sección checkout-step-two', () => {
	...
	it('10741 | TC02 validar first firstName null en formulario chechout', () => {
		formCheck.typeLastName(formCheckOut.lastName);
		formCheck.typeCP(formCheckOut.zipCode);
		formCheck.ClickBtnContinuo();
	...
	it('10741 | TC03 validar last firstName null en formulario chechout', () => {
		formCheck.typeName(formCheckOut.firstName);
		formCheck.typeCP(formCheckOut.zipCode);
		formCheck.ClickBtnContinuo();
	...
	it.skip('10741 | TC04 validar caracteres especiales en formulario checkout', () => {
	...
	it.skip('10741 | TC05 validar mensajes ingreso de caracteres numericos en campos first y last firstName del formulario checkout', () => {
	...
	it('10741 | TC06 validar regreso a seccion cart al hacer click en boton cancel del formulario chechout', () => {
		formCheck.typeName(formCheckOut.firstName);
		formCheck.typeCP(formCheckOut.zipCode);
		formCheck.ClickBtnContinuo();
