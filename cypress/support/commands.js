...
Cypress.Commands.add('userIsloggedIn', () => {
	cy.fixture('DOM/Account/Account.Page').then((the) => {
		...
		cy.get(the.input.username).type(the.data.user) // introducir texto en el campo username

		cy.get(the.input.password).type(the.data.password) // introducir texto en el campo password
...
Cypress.Commands.add('loginUserValid', () => {
	cy.fixture('DOM/swaglabs/GX-4138/login.Page').then((the) => {
		cy.get(the.username.input).type(the.username.data.valid.uStandard).should('have.attr', 'type', 'text')
		cy.get(the.password.input).type(the.password.data.valid).should('have.attr', 'type', 'password')
...
Cypress.Commands.add('loginUserLocked', () => {
	cy.fixture('DOM/swaglabs/GX-4138/login.Page').then((the) => {
		cy.get(the.username.input).type(the.username.data.locked).should('have.attr', 'type', 'text')
		cy.get(the.password.input).type(the.password.data.valid).should('have.attr', 'type', 'password')
		cy.get(the.buttonLogin).click()
	})
})
...
Cypress.Commands.add('loginUserIncorrect', () => {
	cy.fixture('DOM/swaglabs/GX-4138/login.Page').then((the) => {
		cy.get(the.username.input).type(the.username.data.invalid.userIncorrect).should('have.attr', 'type', 'text')
		cy.get(the.password.input).type(the.password.data.invalid.passIncorrect).should('have.attr', 'type', 'password')
		cy.get(the.buttonLogin).click()
	})
})
...
Cypress.Commands.add('loginUserNonExistent', () => {
	cy.fixture('DOM/swaglabs/GX-4138/login.Page').then((the) => {
		cy.get(the.username.input).clear().type(the.username.data.invalid.userNonExistent).should('have.attr', 'type', 'text')
		cy.get(the.password.input).clear().type(the.password.data.invalid.passNonExistent).should('have.attr', 'type', 'password')
		cy.get(the.buttonLogin).click()
	})
})
...
Cypress.Commands.add('loginUserEmptyFields', () => {
	cy.fixture('DOM/swaglabs/GX-4138/login.Page').then((the) => {
		cy.get(the.username.input).click().should('have.attr', 'type', 'text')
		cy.get(the.password.input).click().should('have.attr', 'type', 'password')
		cy.get(the.buttonLogin).click()
	})
})
